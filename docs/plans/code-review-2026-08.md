...
- **Исправление:** TTL достаточен, но стоит задокументировать компромисс.
...
- **Исправление:** логировать предупреждение, рассмотреть опциональный fail-closed режим.
...
- **Исправление:** вытеснять bucket с ближайшим expiry, а не самый старый.
...
- **Статус:** осознанный компромисс; задокументирован. Оставить как есть или добавить per-session токен.
...
- **Исправление:** удалить файлы или убрать запись из CHANGELOG.
...
- **Исправление:** удалить или заменить ссылки на spec в build/, deploy/, Makefile, ранних миграциях.
